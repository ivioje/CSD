...
if selected == 'Email Examples':
   ...
   |--|----------------------------------------------------------------------|----------------------------|
   |1 | A family member needs help: URGENT Your grandson was arrested last night in Mexico. Need bail money immediately Western Union Wire $9,500: https://www.crazygames.com/.| Dear Dan, Thank you for contacting Unity Bank. We sincerely apologize for the inconvenience experienced as a result of this. Kindly hold on for a possible auto reversal period of 24-hours however, if the fund is not reversed within the given period, please revert to enable us to address the issue.|
